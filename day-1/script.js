...
// Animate the logo to slide down and fade in
tl.from(".logo", {
    y: "-30px",
    opacity: 0,
    duration: 1,
...
// Animate the links with a staggered slide-down effect
tl.from(".links h4", {
    y: "-30px",
    opacity: 0,
    duration: 1,
    stagger: 0.5, // Adds delay between each link animation
});

// Animate the main content to slide down, fade in, and scale up
tl.from(".main", {
    y: "-30px",
    opacity: 0,
    duration: 1,
    scale: 0.3, // Starts with a smaller size and scales up
});
